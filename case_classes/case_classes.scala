...
case class Region (
    ...
    bordered_regions: List[Region] = List(),
    border_countries: List[Country] = List(),
    bordered_countries: List[Country] = List(),
    agg_case_data: List[cData] = List(),
