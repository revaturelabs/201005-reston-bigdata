  ...
  def main(args: Array[String]): Unit = {
    ...
    def dataUpdate: Unit = {
      ...
      val json1 = Jsoup.connect("https://disease.sh/v3/covid-19/countries/Algeria%2CAngola%2CBenin%2CBotswana%2" +
        "CBurkinaFaso%2CBurundi%2CCameroon%2CCapeVerde%2CCentral%20African%20Republic%2CChad%2CComoros%2Congo%2C" +
        "CCote%20d'Ivoire%2CDRC%2CDjibouti%2CEgypt%2CEquatorial%20Guinea%2CEritrea%2CEthiopia%2CGabon%2CGambia%2C" +
      ...
      val pw1 = new PrintWriter(new File("s3://adam-king-848/data/africa.json"))
      pw1.write(json1)
      pw1.close()
      ...
      val pw2 = new PrintWriter(new File("s3://adam-king-848/data/asia.json"))
      pw2.write(json2)
      pw2.close()
      ...
      val pw3 = new PrintWriter(new File("s3://adam-king-848/data/caribbean.json"))
      pw3.write(json3)
      pw3.close()
      ...
      val pw4 = new PrintWriter(new File("s3://adam-king-848/data/central_america.json"))
      pw4.write(json4)
      pw4.close()
      ...
      val pw5 = new PrintWriter(new File("s3://adam-king-848/data/europe.json"))
      pw5.write(json5)
      pw5.close()
      ...
      val pw6 = new PrintWriter(new File("s3://adam-king-848/data/north_america.json"))
      pw6.write(json6)
      pw6.close()
      ...
      val pw7 = new PrintWriter(new File("s3://adam-king-848/data/oceania.json"))
      pw7.write(json7)
      pw7.close()
      ...
      val pw8 = new PrintWriter(new File("s3://adam-king-848/data/south_america.json"))
      pw8.write(json8)
      pw8.close()
